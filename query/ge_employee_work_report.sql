WITH qr_summary as (SELECT wd.work_id,wd.start_date,wd.end_date, qr_work_entry.qr_work_id,qr_work_entry.emp_id, qr_work_entry.start_time, qr_work_entry.end_time,qr_work_entry.free_time,qr_work_entry.production_id,qr_work_entry.reason,qr_work_entry.work_sts,
...
FROM qr_work_entry
    ...
    WHERE
   qr_work_entry.work_done_id = 1861 group by qr_work_entry.qr_work_id)
