...
LEFT JOIN bom_correction
   ...
   AND bom_correction.outpart_bom_id = 569 and bom_correction.bom_output_id = bom_output.bom_id

WHERE bom_output.bom_id = 569
UNION ALL
SELECT 
...
LEFT JOIN bom_correction bom_correction_child
   ...
   AND bom_correction_child.outpart_bom_id = 569 and bom_correction_child.bom_output_id = bom_output_child.bom_id
