...
( SELECT sales_order_form.*,hs.type_id as hstype_id,hs.model_id,hs.sub_type,hs.ass_date,hs.ass_id,line_no
    FROM
        ...
        inner join machine_line on machine_line.ass_id = assign_product.ass_id where assign_type = "production"  and finished_details = 'no_sts' and assign_product.dated <= NOW()
    ) AS hs
