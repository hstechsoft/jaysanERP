...
$sql = "SELECT tp.*,pwt.process,jp.process_name, if(tp.part_id IS not NULL, concat(pt.part_name,'(',jp.process_name,')'), concat('Semi-finished part(', final_part.part_name, jp.process_name)) as part FROM `transport_parts` tp
