...
FROM (
SELECT 
    DATE_ADD(UNIX_TIMESTAMP(CONCAT(CURDATE(), ' 00:00:00')), INTERVAL t.n DAY) AS Date
FROM 
    (SELECT 
...
WHERE 
    DATE_ADD(UNIX_TIMESTAMP(CONCAT(CURDATE(), ' 00:00:00')), INTERVAL t.n DAY) BETWEEN UNIX_TIMESTAMP(CONCAT(CURDATE(), ' 00:00:00')) AND UNIX_TIMESTAMP(NOW()) * 1000 
) date_series
LEFT JOIN (
SELECT 
