<?php
 ...
 $day_end_time = test_input($_POST['day_end_time']);
 if($day_end_time == "" || $day_end_time == null)
 {
   $day_end_time = "NOW()";
 }
 else
...
$sql_end_work = "UPDATE work_done_table SET end_date = $day_end_time WHERE work_id = $work_done_id";
