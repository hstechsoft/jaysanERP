...
$complaint = test_input($_GET['complaint']);
...
$sql .= "INSERT INTO dealer_service (cus_name, cus_phone, cus_addr, chasis_no, simage, implement, model, remark, did,complaint,cus_id,work_id) VALUES ($cus_name, $cus_phone, $cus_addr, $chasis_no, $dimage, $implement, $model, $remark, $did,$complaint,$cus_id,0)";
