...
$tally_json = [
            ...
            "CustomerName"=> $po['po_buyer_name'], 
            "MailingName"=> $po['po_buyer_name'],  
            "BillingAddress"=> $po['po_buyer_address'], 
            "ConsigneeName"=> $po['po_buyer_name'], 
            "ShippingAddress"=> $po['po_buyer_address'], 
            "BillingPinCode"=> "600001", 
            "ShippingPinCode"=> "641048", 
            "BillingPhoneNo"=> "NULL", 
            "ShippingPhoneNo"=> $po['po_buyer_mobile'], 
            "TotalAmount"=> round($total_amount, 2), 
            "BillingState"=> $po['po_buyer_state'], 
            "BillingCountry"=> "India", 
            "ShippingState"=> $po['po_buyer_state'], 
