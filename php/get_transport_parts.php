...
$sql = "with transport as(SELECT sr.reserve_type,sr.reserve_type_id,dc.*,js.godown,js.dep,js.sec,creditor_name,dep.dep_name,ds.sec_name, JSON_ARRAYAGG(JSON_OBJECT('stock_reserve_id',sr.stock_reserve_id,'part_id',js.part_id,'process_id',js.process_id,'part_name',ifnull(pt.part_name, CONCAT('semi finished part (', jp.process_name, ')')) ,'process_name', jp.process_name,'qty',sr.reserve_qty,'stock_id',sr.stock_id,'godown',js.godown)) as parts from  transport_dc tdc
...
left join department dep on js.dep = dep.dep_id 
 ...
 WHERE tdc.source_godown = $godown and tdc.sts = 'create'
