...
(SELECT ifnull(sum(jp.amount),0) as paid_amount FROM jaysan_payment jp WHERE  jp.sts = 'approved' and jp.oid in (SELECT sof.oid from sales_order_form sof WHERE sof.order_no in ( $oid_arr))) as paid from 
