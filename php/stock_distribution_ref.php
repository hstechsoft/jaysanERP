...
// get demaned material from input_part_demand_view
 $sql_work_order_demand = "select needed as remaining_reserve_qty from input_part_demand_view where previous_process_id <=> $in_process_id and input_part_id <=> $in_part_id and godown = $godown  GROUP BY stock_distribution,input_part_id,previous_process_id, godown, dep, sec";
