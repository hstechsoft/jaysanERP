...
$sql = "UPDATE company SET  company_name = $company_name,company_address = $company_address,company_terms = $company_terms,company_terms_pi = $company_terms_pi,company_terms_q = $company_terms_q,company_logo = $company_logo,company_bank = $company_bank,gst = $gst,company_logo1 = $company_logo1,qno_seq = $qno_seq,ino_seq = $ino_seq,pino_seq = $pino_seq";
