...
left join parts_tbl final_part on final_part.part_id = pwt.output_part
 ...
 group by dcp.dc_id";
                                ...
                                <table class="table caption-top table-bordered table-striped " style="font-size: 12px;"
                                   ">
                                    <thead class="small">
                                        ...
                                        <tr>
                                            <th scope="col" colspan="4" id="vendor">Vendor</th>
                                            <th scope="col" id="dc_no">
                                                <input type="text" class="form-control form-control-sm rounded-3" id="in_dc_no"
                                                    placeholder="DC/No">
                                            </th>
                                            <th scope="col" id="dc_datee">
                                                <input type="datetime-local" id="dc_date"
                                                    class="form-control form-control-sm rounded-3" placeholder="DC Date">
                                            </th>

                                        </tr>

                                        <tr>
                                            <th scope="col" colspan="5" id="transport_descriptionn">
                                                <input type="text" class="form-control form-control-sm rounded-3"
                                                    id="transport_mode" placeholder="Mode Of Transport">
                                            </th>
                                            <th scope="col" id="mode_of_transportt">
                                                <input type="text" class="form-control form-control-sm rounded-3"
                                                    id="transport_des" placeholder="Transport Description">

                                            </th>
                                            <th scope="col" id="vehicle_noo">
                                                <input type="text" class="form-control form-control-sm rounded-3" id="vehicle_no"
                                    ...
                                    <tbody class="small" id="parts_tbody">
                                        ...
                                        <tr class="total-row fw-bold">
                                            ...
                                            <td>'. $total_qty .'</td>
                                            <td></td>
                                            <td colspan="1" class="text-end">'. $total_amount .'</td>
                                        </tr>
    ...
    $data = [
        ...
        'unique_file' => "yes",
        'header_html' => "<h5 class='text-center' style='text-align: center;'> DELIVERY CHALLAN</h5>",
