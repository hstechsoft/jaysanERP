...
left join jaysan_stock js on pwt.process_id = js.process_id and iwp.input_part_id = js.part_id and js.godown = $godown_id and js.dep = $dep_id and js.sec = $sec_id  
