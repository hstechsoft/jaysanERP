...
<?php
 ...
 $pinos =test_input($_GET['pinos']);
 $spino =test_input($_GET['spino']);
...
$sql = "INSERT  INTO  proforma_invoice (spino,pinos,pino,cus_name,cus_addr,dated,shipping,total_value,emp_id,cus_id,place_of_supply,valid_until,enq_no,taxable_amount,cus_gst)
 VALUES ($spino,$pinos,$qno,$cus_name,$cus_addr,$dated,$shipping,$total_value,$emp_id,$cus_id,$place_of_supply,$valid_until,$enq_no,$taxable_amount,$cus_gst)";
