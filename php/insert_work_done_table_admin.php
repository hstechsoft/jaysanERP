...
$day_start_time = test_input($_POST['day_start_time']);
if($day_start_time == "" || $day_start_time == null)
{
  $day_start_time = "NOW()";
}
else
...
return $data;
 ...
 $sql = "INSERT INTO work_done_table (emp_id,start_date,current_process_id,current_machine_id,part_id,godown_id,dep_id,sec_id) VALUES ($emp_id, $day_start_time, $current_process_id, $current_machine_id, $part_id, $godown_id, $dep_id, $sec_id)";
