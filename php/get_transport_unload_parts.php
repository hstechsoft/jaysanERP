...
left join department dep on js.dep = dep.dep_id 
 ...
 WHERE tp.current_transport = $transport_godown and tp.sts <> 'create' and tp.sts = 'transport' and tp.des_godown = $des_godown
group by sr.reserve_type,sr.reserve_type_id,js.godown,js.dep,js.sec)

SELECT stock_reserve_id,dc_no, reserve_type,reserve_type_id,bill_to,ship_to,JSON_ARRAYAGG(JSON_OBJECT('godown',godown,'dep',dep,'sec',sec,'creditor_name',creditor_name,'dep_name',dep_name,'sec_name',sec_name,'parts',parts)) as parts from transport
