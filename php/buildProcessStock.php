...
$sql_stock = "select stock_reserve_view.part_id,stock_reserve_view.process_id,if(stock_reserve_view.part_id is null, concat('semi finished part of','(',part_name,')'),parts_tbl.part_name) as part_name, available_qty,stock_id,godown,dep,sec from stock_reserve_view
