...
$sql_stock = "select jaysan_stock.part_id,jaysan_stock.process_id,if(jaysan_stock.part_id is null, concat('semi finished part of','(',part_name,')'),parts_tbl.part_name) as part_name, qty,stock_id,godown,dep,sec from jaysan_stock
left join process_wel_tbl pwt on jaysan_stock.process_id <=> pwt.process_id
...
where jaysan_stock.process_id in ($process_ids_str)";
