...
$sql .= "UPDATE  sales_order_form SET order_category =  $order_category,product_id =  $product_id,customer_id =  $customer_id,order_type =  $order_type,oe_supply =  $oe_supply,commitment_date =  $commitment_date,required_qty =  $required_qty,color_choice =  $color_choice,color_choice_des =  $color_choice_des,chasis_choice =  $chasis_choice,chasis_choice_des =  $chasis_choice_des,any_other_spec =  $any_other_spec,loading_type =  $loading_type,emp_id =  $emp_id,production_untill =  $production_untill,pincode =  $pincode,delivery_addr =  $delivery_addr,total_payment =  $total_payment,type_id =  $type_id,nex_payment_date = $nex_payment_date WHERE oid =  $sales_oid";
