...
try {
 $sql_insert_master = "UPDATE nesting_master SET created_by = $created_by, nesting_name = $nesting_name, material_id = $material_id, nesting_type = $nesting_type, std_length = $std_length, scrap_part_id = $scrap_part_id, weight = $weight, scarp_weight = $scarp_weight WHERE nes_master_id = $nes_master_id";
