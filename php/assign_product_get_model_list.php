...
//     oid";
 ...
 $sql = "SELECT info.model_id,jaysan_product_model.model_name,jaysan_product_model.product_id from(
    SELECT
        sales_order_product.opid,
        sales_order_product.oid,
        sales_order_form.customer_id,
    ...
    WHERE
        ...
        GROUP BY
            assign_product.opid
    )) as info INNER JOIN jaysan_product_model on info.model_id = jaysan_product_model.model_id WHERE jaysan_product_model.product_id = $product_id GROUP by jaysan_product_model.model_id ";
