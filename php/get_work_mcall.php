...
// $sql = "SELECT work_description,work_date,work_type,work.emp_id,work_id,work_com_status,emp_name,work_status  FROM work INNER JOIN employee ON employee.emp_id = work.emp_id where work.cus_id = $cus_id and work.work_assign_status = 'accept'  ORDER BY work_date";
