...
customer.cus_phone,jaysan_model_type.type_name as type,line_no as qr_no,prepared_by, chasis_no,production_id FROM
( SELECT sales_order_form.*,hs.type_id as hstype_id,hs.model_id,hs.sub_type,hs.ass_date,hs.ass_id,line_no,prepared_by, chasis_no,production_id
    FROM
        (
        SELECT
            sales_order_product.*,
            ...
            (select emp_name from employee where employee.emp_id = machine_production_taken.prepared_by) as prepared_by,
            assign_product.ass_id,
            assign_product.chasis_no,
