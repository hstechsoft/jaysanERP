...
customer.cus_phone,jaysan_model_type.type_name as type,line_no as qr_no,prepared_by, chasis_no FROM
( SELECT sales_order_form.*,hs.type_id as hstype_id,hs.model_id,hs.sub_type,hs.ass_date,hs.ass_id,line_no,prepared_by, chasis_no
    FROM
        (
        SELECT
            sales_order_product.*,
