...
$sql = "UPDATE work SET   work_status =  $his_status,work_date = $work_date_p, work_com_status = $work_com_status,last_att =  $last_att_p WHERE work_id= $work_id_p";
...
$sql = "INSERT INTO work_history (work_id,his_date,comments,cus_id,emp_id,his_status)VALUES ($work_id_p,$last_att_p,'$remark_p',$cus_id, $his_emp_id , $his_status);";
