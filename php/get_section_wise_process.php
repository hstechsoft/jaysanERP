...
return $data;
 ...
 $sql = "with  sec_wise as (SELECT pwt.previous_process_id, pwt.process,pwt.process_id,pwt.process_title,wtm.dep_id,wtm.dep_sec_id,wtm.godown_id,wtm.wtid FROM work_time_master wtm inner JOIN process_wel_tbl pwt on wtm.ori_process_id = pwt.process_id WHERE  wtm.godown_id = $godown_id and wtm.dep_id = $dep_id and wtm.dep_sec_id = $sec_id and wtm.machine_id = $machine_id), 
