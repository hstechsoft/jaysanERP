...
$production_date_query  = ($_GET['production_date']) == '' ? 0 : "dated  =  '" . ($_GET['production_date']) . "'";
...
//                        final as( SELECT ap_final.assign_details,sp.* from ap_final INNER join sop_view sp on ap_final.opid = sp.opid     ) 
