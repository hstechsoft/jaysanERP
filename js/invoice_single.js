...
console.log(des)
   ...
   function get_invoice_details()
   {
    ...
    $.ajax({
        url: "php/get_invoice_details_single.php",
        type: "get", //send it through get method
        data: {
            qno : qno
...
total_value = obj.total_value
   ...
   function get_quotion_single()
   {
    ...
    $.ajax({
        url: "php/get_invoice_single.php",
        type: "get", //send it through get method
        data: {
            qno : qno
      ...
      if (response.trim() != "error") {
        ...
        if((response.trim() != "0 result"))
        {
          ...
          $("#print_pro_table").append("<tr><td colspan='7'> <div> <div class='d-flex justify-content-end gap-5 '> <p class='p-0 m-0'> Total Taxable Value: </p> <p class='p-0 m-0'> &#x20B9 "+ taxable_amount.toFixed(2) +   "</p> </div> <div class='d-flex justify-content-end gap-5 '> <p class='p-0 m-0'> Total Tax Amount: </p> <p class='p-0 m-0'> &#x20B9 " + tax_amount.toFixed(2) +"</p> </div><div class='d-flex justify-content-end gap-5 '> <p class='p-0 m-0'> Discount:</p> <p class='p-0 m-0'> &#x20B9 " +discount +"</p> </div> <div class='d-flex justify-content-end gap-5 '> <p class='p-0 m-0'> Shipping & Packaging Amount: </p> <p class='p-0 m-0'> &#x20B9 "+ shipping.toFixed(2) +"</p> </div> <div class='d-flex justify-content-end gap-5 '> <p class='p-0 m-0'> Total Value: </p> <p class='p-0 m-0'> &#x20B9 " + gt.toFixed(2) + "</p> </div> </div> </td></tr>")
