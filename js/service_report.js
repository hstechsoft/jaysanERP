...
var si = ""
  ...
  si = "Compliant Type - " + obj.complaint_type + "<br>" +"brand Name - " + obj.brand_name + "<br>"+"warranty- " + obj.warranty + "<br>"+"amc- " + obj.amc + "<br>"+"service_type- " + obj.service_type 
   count  = count + 1;
