...
$(document).ready(function(){
 ...
 get_all_quoation();
   ...
   function get_all_quoation()
   {

  

$.ajax({
  url: "php/get_estimate_all.php",
...
var count =0 
  obj.forEach(function (obj) {
   ...
   count  = count + 1;
    ...
    $("#quote_table").append(" <tr> <td>"+ count + "</td> <td>"+ obj.eno + "</td><td>"+ obj.cus_name + "<br>" + obj.cus_addr + "</td> <td>"+ millis_to_date(parseFloat(obj.dated)) + "</td> <td>"+ obj.total_value + "</td> <td><a target='_blank' href=' estimation_single.html?qno="+ obj.eno + "' class='btn btn-primary btn-sm' role='button'>View</a></td> </tr>")
