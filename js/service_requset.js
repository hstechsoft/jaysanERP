...
//   $("#service_table").on("click","tr td a", function(event) {
//     //get button value
...
href = href +  "&listner_id="+ lis_id + "&work_type=warranty claim"+"&work_des=warranty claim requested"
  ...
  const interval = window.setInterval(function () {
    ...
    if(lis_work_id != "")
    {
      $('#task_modal').modal('hide'); 
       ...
       update_service(service_id,lis_work_id);
   ...
   function update_service(service_id,work_id)
   {  
...
$.ajax({
  ...
  error: function (xhr) {
   ...
   {
     $.ajax({
       url: "php/get_service_request.php",
       type: "get", //send it through get method
       data: {
...
console.log(response);
      ...
      count = count + 1;
      $('#service_table').append("<tr><td>"+count+"</td><td style='min-width: 120px;'>"+obj.sdate+"</td><td style='min-width: 120px;'>"+obj.dname+"</td><td style='min-width: 120px;'>"+obj.cus_name+"</td><td style='min-width: 120px;'>"+obj.cus_phone+"</td><td style='min-width: 150px;'>"+obj.cus_addr+"</td><td style='min-width: 120px;'>"+obj.chasis_no+"</td><td>"+obj.implement+"</td><td style='min-width: 120px;'>"+obj.model+"</td><td style='min-width: 200px;'>"+obj.complaint+"</td><td style='min-width: 300px;'>"+obj.remark+"</td><td>"+attach+"</td></td>  <td>" + "<a target='_blank' value='"+obj.dsid + "' href='create_work.html?work_cus_id=" + obj.cus_id + "' class='btn btn-primary btn-sm' role='button' value ="+obj.dsid + ">Add</a>" + "</td></tr>")
