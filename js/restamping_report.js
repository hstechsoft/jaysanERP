...
$.ajax({
  url: "php/get_restamping_all.php",
...
var si = ""
  ...
  si = "Machine Type - " + obj.machine_type + "<br>" +"Platform Size - " + obj.platform_size + "<br>"+"Capacity- " + obj.capcity + "<br>"+"Brand- " + obj.brand_name + "<br>"+"Stamping Certificate- " + obj.stamp_cer + "<br>"+"Stamping plate - " + obj.stamp_plate + "<br>"+"stamp date- " + obj.stamp_date
   count  = count + 1;

    $("#quote_table").append(" <tr> <td>"+ count + "</td> <td>"+ obj.emp_name + "</td><td>"+ obj.cus_name + "<br>" +  obj.cus_phone + "</td> <td>"+ si + "</td> <td>"+ obj.amount + "</td> <td>"+ obj.remark + "</td></tr>")
