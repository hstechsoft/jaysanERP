...
$(document).ready(function(){
   ...
   {
    $("#task_btn").attr("onclick", "window.location.href = 'emp_single_task.html?phone_id=" + phone_id +"';");
    $("#att_btn").attr("onclick", "window.location.href = 'emp_single_att.html?phone_id=" + phone_id + "';");
    $("#leave_btn").attr("onclick", "window.location.href = 'emp_tour.html?phone_id=" + phone_id + "';");
    $("#tour_btn").attr("onclick", "window.location.href = 'emp_tour.html?phone_id=" + phone_id + "';");
    $("#exp_btn").attr("onclick", "window.location.href = 'expense_single_phone.html?phone_id=" + phone_id + "';");
...
var count =0 
  ...
  error: function (xhr) {
   ...
   $.ajax({
     url: "php/emp_tour_sum_phone.php",
     type: "get", //send it through get method
     data: {
      emp_id : current_user_id,
