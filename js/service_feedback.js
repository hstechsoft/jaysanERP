...
//   $("#feedback_table").on("click","tr td a", function(event) {
//     //get button value
...
$("#feedback_table").on("click","tr td a", function(event) {
 ...
 var feedback_id =  $(this).attr("value")

href = href +  "&listner_id="+ lis_id + "&work_type=service feedback"+"&work_des=service feedback"
  ...
  const interval = window.setInterval(function () {
    ...
    if(lis_work_id != "")
    {
      $('#task_modal').modal('hide'); 
       ...
       update_feedback(feedback_id,lis_work_id);
   ...
   function update_feedback(feedback_id,work_id)
   {  


$.ajax({
  url: "php/update_fedback.php",
  ...
  error: function (xhr) {
   ...
   function get_feedback_request()
   {
     $.ajax({
       url: "php/get_feedback_request.php",
       type: "get", //send it through get method
       data: {
...
console.log(response);
      ...
      count = count + 1;
      $('#feedback_table').append("<tr><td>"+count+"</td><td style='min-width: 120px;'>"+obj.review_date+"</td><td style='min-width: 120px;'>"+obj.dealer_name+"</td><td style='min-width: 120px;'>"+obj.service_person_name+"</td><td style='min-width: 120px;'>"+obj.cus_name+"</td><td style='min-width: 120px;'>"+obj.cus_phone+"</td><td style='min-width: 150px;'>"+obj.cus_addr+"</td><td style='min-width: 120px;'>"+obj.chasis_no+"</td><td>"+obj.implement+"</td><td style='min-width: 120px;'>"+obj.rating_dealer+"</td><td style='min-width: 200px;'>"+obj.rating_service+"</td> <td>" + "<a target='_blank' value='"+obj.review_id + "' href='create_work.html?work_cus_id=" + obj.cus_id + "' class='btn btn-primary btn-sm' role='button' value ="+obj.review_id + ">Add</a>" + "</td></tr>")
        ...
        $("#feedback_table") .append("<tr class = 'text-bg-danger'><td colspan='9' scope='col'>No Data</td></tr>");
      }
      }
