...
var his_query="SELECT * FROM expense_payment   where emp_id=" + current_user_id
var query_exp = "SELECT * FROM expense inner join employee on employee.emp_id = expense.exp_emp_id where exp_emp_id=" + current_user_id +" and exp_approve = 'no'"
...
$(document).ready(function(){
  ...
  $('#reportTabs button').on('shown.bs.tab', function (e) {
    ...
    switch (e.target.id) {
      case 'unapprove-tab':
         his_query="SELECT * FROM expense_payment   where emp_id=" + current_user_id
         query_exp = "SELECT * FROM expense inner join employee on employee.emp_id = expense.exp_emp_id where exp_emp_id=" + current_user_id +" and exp_approve = 'no'"
        ...
        case 'decline-tab':
          $('#exp_del_btn').show()
          his_query="SELECT * FROM expense_payment   where emp_id=" + current_user_id
         query_exp = "SELECT * FROM expense inner join employee on employee.emp_id = expense.exp_emp_id where exp_emp_id=" + current_user_id +" and exp_approve = 'decline'"
  ...
  date_query = " and 1"
  his_query="SELECT * FROM expense_payment   where emp_id=" + current_user_id
  query_exp = "SELECT * FROM expense inner join employee on employee.emp_id = expense.exp_emp_id where exp_emp_id=" + current_user_id +""
...
this_row.find('td:eq(5) input:checkbox')[0].checked = true
 ...
 $('#sel_exp_sts_in').change(function() {
   var sel_type_query = $('#sel_exp_sts_in').find(":selected").text()
   $("#exp_cat_txt").text("Declined") 
...
function update_admin_emp_exp()
{


$.ajax({
url: "php/delete_emp_exp.php",
