...
var count =0 
  obj.forEach(function (obj) {
   ...
   count  = count + 1;
    ...
    $("#quote_table").append(" <tr> <td>"+ count + "</td> <td>"+ obj.qno + "</td><td>"+ obj.cus_name + "<br>" + obj.cus_addr + "</td> <td>"+ millis_to_date(parseFloat(obj.dated)) + "</td> <td>"+ obj.total_value + "</td> <td><a target='_blank' href=' quotation_single.html?qno="+ obj.qno + "' class='btn btn-primary btn-sm' role='button'>View</a></td> </tr>")
