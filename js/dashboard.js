...
$('#report_btn').click(function () {
  if(selected_work_type == "service")
  {
    window.open('service_entry.html?cus_id=' + selected_cus_id + '&phone_id=' + phone_id);
 
  }
  else if(selected_work_type == "restamping")
  {
    window.open('restamping_entry.html?cus_id=' + selected_cus_id + '&phone_id=' + phone_id);
