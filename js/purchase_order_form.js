...
company_con = company_con.replace(/^_+|_+$/g, '');
    ...
    $("#terms_btn").on("click", function (e) {
        ...
        $("#purchase_order_details").append("<tr><td></td><th scope='col' colspan='2' class='text-center'>Total</th></td><td></td><td></td><td></td><td></td><td id='raw_material_total_amount_id'>" + $("#raw_material_total_amount_id").text() + "</td></tr>" +
