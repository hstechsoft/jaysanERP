      ...
      if (response.trim() != "error") {
        ...
        if (response.trim() != "0 result") {
          ...
          obj.sort(function(a, b){
            return parseInt(b.dcf_id) - (a.dcf_id);
          })
          ...
          obj.forEach(function (obj) {
            ...
            $('#dcf_list_mobile_view').append("<li class='list-group-item d-md-none'> <div class='d-block justify-content-between align-items-center'> <div> <p><strong>DCF ID:</strong> " + obj.dcf_id + "<strong>Sale order/no:</strong> " + obj.order_no + "</p><br><strong>Date:</strong> " + obj.dated + "<br><strong>Employee:</strong> " + obj.emp_name + "<br><strong>Consignee:</strong> " + obj.consignee + "</div> <button class='btn btn-sm btn-primary mt-2 p-1 float-end' value='" + obj.dcf_id + "' style='font-size:10px'>View</button> </div> </li>");
          });
