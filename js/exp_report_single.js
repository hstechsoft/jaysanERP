            ...
            $('#report_search_btn').on('click', function()
{
  ...
  get_exp_summary()
   ...
   {
     $.ajax({
       url: "php/get_exp_report_single.php",
...
if (response.trim() != "error") {
  ...
  var total =0
    ...
    total = total + parseFloat(obj.exp_amount)
      $("#exp_table").append(" <tr><td>"+ count + "</td><td>"+ millis_to_date_only(parseFloat(obj.exp_date)) +  "</td><td>"+ obj.exp_cat +  "</td><td>"+ obj.exp_des +  "</td><td>"+obj.exp_amount +  "</td> </tr>")
   ...
   {
     $.ajax({
       url: "php/get_exp_report_cat.php",
       type: "get", //send it through get method
       data: {
        emp_id : current_user_id,
        date_query_start : date_query_start,
