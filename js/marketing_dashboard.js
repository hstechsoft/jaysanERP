        ...
        success: function (response) {
            ...
            if (response.trim() != "error") {
                ...
                <td>₹<b class="text-primary">${item.total_amount}</b></td>
                        ...
                        let productHtml = `<div style="max-height:230px;overflow:auto">
                  ...
                  <tr>
                    ...
                    <td>₹${p.total_amount.toLocaleString('en-IN')}</td>
                        ...
                        let cusHtml = `<div style="max-height:200px;overflow:auto">
              <table class="table table-sm">
            ...
            datasets: [
                {
                    label: 'Monthly Sales',
                    data: [
                        200000, 300000, 450000, 500000,
                        600000, 350000, 420000, 380000,
                        500000, 620000, 450000, 680000
                    ],
                    borderRadius: 8
                },
                {
                    ...
                    type: 'line',
                    data: [
                        400000, 400000, 400000, 425000,
                        425000, 425000, 500000, 500000,
                        500000, 341666, 341666, 341668
                    ],
                    tension: 0.4
                }
            ]
