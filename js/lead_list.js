     ...
     $.ajax({
      ...
      obj.forEach(function (obj) {
        ...
        if(obj.attach_id != "")
        {
            ...
            attach = "<div><button onclick = location.href='"+ obj.attach_id + "'; class='btn '><i class='fa-solid fa-photo-film'></i></button></div>"
        }
