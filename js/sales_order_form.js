...
$(document).ready(function () {
  ...
  $('#sales_product, #product_details_mobile_view').on("click", "button", function () {
    var opid = $(this).val()
    var oid = $(this).data("oid")
  ...
  $("#advance_payment_tbody").on("dblclick", "tr", function () {
    ...
    $("#amount").val(amt_enter).trigger("change");
