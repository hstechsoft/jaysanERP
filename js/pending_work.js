...
$(document).ready(function(){
 ...
 get_pending_work_all();
   ...
   function get_pending_work_all()
   {

  

$.ajax({
  url: "php/get_pending_work_all.php",
...
var count =0 
  obj.forEach(function (obj) {
   ...
   count  = count + 1;
    ...
    $("#pendig_work_table").append(" <tr> <td>"+ count + "</td> <td>"+ obj.emp_name + "</td><td>"+ obj.comments + "</td>  <td>" +obj.work_count+ "</td></tr>")
    ...
    $("#pendig_work_table").append(" <tr><td colspan='4' scope='col' class='text-bg-danger h6'>Sorry no data!</td></tr>")
  }
}
